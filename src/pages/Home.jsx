...
import Hero from "../assets/hero-car1.jpg"; 
...
<section className="py-16" id="about">
      ...
      <section className="bg-gray-100 py-16" id="service">
        <div className="container mx-auto px-4">
          ...
          <button className="mt-12 mx-auto block bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg text-lg font-medium transition">
