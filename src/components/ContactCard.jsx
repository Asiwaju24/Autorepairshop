  ...
  const contactMethods = [
    {
      icon: Phone,
      title: 'Phone',
      details: '+2349066964407',
      description: 'Call us for immediate assistance'
    },
    {
      icon: Mail,
      title: 'Email',
      details: 'arautomotivetechnologycompany.gmail.com',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Thank you for contacting AR Auto Repair. We'll get back to you within 24 hours.
            </p>
            <button
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-red-600 text-sm">
                    For urgent roadside assistance, call us directly at <strong>+2349066964407</strong>
                  </p>
                </div>
              </div>
            </div>
